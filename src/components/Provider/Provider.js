...
//Creates API, which provides methods for accessing Data Store
...
export function Provider(props) {
    ...
    let providerRegister = props.providerRegister;

    useEffect(() => {
        let provider = createProviderAPI(props.url, props.id, createDataStore(), props.updateState);
        if(!props.effects){
